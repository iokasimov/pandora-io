...
import "pandora" Pandora.Pattern.Operation.Exponential (type (-->))
import "pandora" Pandora.Pattern.Operation.Product ((:*:) ((:*:)))
import "pandora" Pandora.Pattern.Operation.One (One (One))
